...
public class CustomDBUnitExtension implements BeforeTestExecutionCallback, AfterTestExecutionCallback, BeforeEachCallback {

    private static final ExtensionContext.Namespace namespace = ExtensionContext.Namespace.create(com.github.database.rider.junit5.DBUnitExtension.class);
    ...
    public void beforeTestExecution(ExtensionContext extensionContext) throws Exception {
        ...
        DataSetExecutor dataSetExecutor = CustomDataSetExecutorImpl.instance(executorId, connectionHolder);
    ...
    private ConnectionHolder getConnectionFromSpringContext(ExtensionContext extensionContext, String executorId) {
        ...
        try {
            DataSetExecutor dataSetExecutor = CustomDataSetExecutorImpl.getExecutorById(executorId);
