...
@Transactional
public class UnAssignUserRoleTest {
    ...
    public void nullRuleToNullUser() {
        final var exception = Assertions.assertThrows(ResourceNotFoundException.class, () -> assignService.unAssignUserRole(null, null));
    ...
    public void negativeRuleIdToNullUser() {
        final var exception = Assertions.assertThrows(ResourceNotFoundException.class, () -> assignService.unAssignUserRole(null, -1L));
        Assertions.assertNotNull(exception);
        Assertions.assertNotNull(exception.getMessages());
        Assertions.assertEquals(1, exception.getMessages().size());
        Assertions.assertEquals(format(VALIDATION_NOT_FOUND_MSG, USER, "null"), exception.getMessages().get(0));
    ...
    public void zeroRuleIdToNullUser() {
        final var exception = Assertions.assertThrows(ResourceNotFoundException.class, () -> assignService.unAssignUserRole(null, 0L));
        Assertions.assertNotNull(exception);
        Assertions.assertNotNull(exception.getMessages());
        Assertions.assertEquals(1, exception.getMessages().size());
        Assertions.assertEquals(format(VALIDATION_NOT_FOUND_MSG, USER, "null"), exception.getMessages().get(0));
    ...
    public void nullRuleToNegativeUserId() {
        final var userId = -1L;
        final var exception = Assertions.assertThrows(ResourceNotFoundException.class, () -> assignService.unAssignUserRole(userId, null));
        Assertions.assertNotNull(exception);
        Assertions.assertNotNull(exception.getMessages());
        Assertions.assertEquals(1, exception.getMessages().size());
    ...
    public void negativeRuleIdToNegativeUserId() {
        final var userId = -1L;
        final var exception = Assertions.assertThrows(ResourceNotFoundException.class, () -> assignService.unAssignUserRole(userId, -1L));
        Assertions.assertNotNull(exception);
        Assertions.assertNotNull(exception.getMessages());
        Assertions.assertEquals(1, exception.getMessages().size());
        Assertions.assertEquals(format(VALIDATION_NOT_FOUND_MSG, USER, userId), exception.getMessages().get(0));
    ...
    public void zeroRuleIdToNegativeUserId() {
        final var userId = -1L;
        final var exception = Assertions.assertThrows(ResourceNotFoundException.class, () -> assignService.unAssignUserRole(userId, 0L));
        Assertions.assertNotNull(exception);
        Assertions.assertNotNull(exception.getMessages());
        Assertions.assertEquals(1, exception.getMessages().size());
        Assertions.assertEquals(format(VALIDATION_NOT_FOUND_MSG, USER, userId), exception.getMessages().get(0));
